...
BOOST_PYTHON_MODULE(_caffe) {
    ...
    .add_property("shape",
        bp::make_function(
            static_cast<const vector<int>& (Blob<Dtype>::*)() const>(
                &Blob<Dtype>::shape),
            bp::return_value_policy<bp::copy_const_reference>()))
    .def("shape_string", &Blob<Dtype>::shape_string)
  ...
  // bp::class_<Blob<signed char>, shared_ptr<Blob<signed char> >, boost::noncopyable>(
    // "Blob", bp::no_init)
    // .add_property("shape",
        // bp::make_function(
            // static_cast<const vector<int>& (Blob<signed char>::*)() const>(
                // &Blob<signed char>::shape),
            // bp::return_value_policy<bp::copy_const_reference>()))
    // .def("shape_string", &Blob<signed char>::shape_string)
    // .add_property("num",      &Blob<signed char>::num)
    // .add_property("channels", &Blob<signed char>::channels)
    // .add_property("height",   &Blob<signed char>::height)
    // .add_property("width",    &Blob<signed char>::width)
    // .add_property("count",    static_cast<int (Blob<signed char>::*)() const>(
        // &Blob<signed char>::count));
  // BP_REGISTER_SHARED_PTR_TO_PYTHON(Blob<signed char>);

  bp::class_<Layer<Dtype>, shared_ptr<PythonLayer<Dtype> >,
    boost::noncopyable>("Layer", bp::init<const LayerParameter&>())
    
    .add_property("blobs", bp::make_function(&Layer<Dtype>::blobs, bp::return_internal_reference<>()))
    .add_property("int8blobs", bp::make_function(&Layer<Dtype>::int8blobs, bp::return_internal_reference<>()))

    .def("int8blobsshapestring", &Layer<Dtype>::int8blobsShapeString)
    .def("int8blobssize", &Layer<Dtype>::int8blobsSize)
    .def("showint8blobs", &Layer<Dtype>::showInt8blobs)
